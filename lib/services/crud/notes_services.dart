...
//         {
//           textColumn: text,
//           isSyncesWithCloudColumn: 0,
//         },
//         where: 'id = ?',
//         whereArgs: [note.id]);

//     if (updateCount == 0) {
//       throw CoundNotUpdateNote();
//     } else {
...
//         {userIdColumn: owner.id, textColumn: text, isSyncesWithCloudColumn: 1});
...
//     try {
//       await open();
//     } on DatabaseAlreadyOpenExceoption {
//       // empty
//     }
//   }
...
//         isSyncedWithCloud =
//             (map[isSyncesWithCloudColumn] as int) == 1 ? true : false;
...
// const isSyncesWithCloudColumn = "is_synced_with_cloud";

// // This code is sql for create note table
...
// // This code is sql for create user table
